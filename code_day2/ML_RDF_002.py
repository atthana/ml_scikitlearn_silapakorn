...
# เนื่องจากชุดข้อมูลเบาหวานใน sklearn เป็นปัญหา Regression
# จึงปรับให้เป็น Classification โดยการแปลง Target เป็น 2 คลาส
import numpy as np
X = diabetes.data  # คุณลักษณะ (Features)
y = np.where(diabetes.target > np.median(diabetes.target), 1, 0)  # แปลง Target เป็น Binary (1 หรือ 0)
